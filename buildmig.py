...
# wget git clone https://github.com/jwisecarver-mm/migration_script && chmod +x ./migration_script/buildmig.py &&./migration_script/buildmig.py
...
print "Attempting to automatically fetch Stratus DB credentials..."
...
local_install_root = raw_input("Stratus install root:")
